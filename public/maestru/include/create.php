...
if (isset($configuracoes) || (!empty($dados['sitename']) && !empty($_FILES['favicon']['name']))) {
    ...
    if (requireConnectionDatabase($dados)) {
        ...
        Config\Config::writeFile("index.php", file_get_contents("public/maestru/installTemplates/index.php"));
        Config\Config::writeFile("apiGet.php", file_get_contents("public/maestru/installTemplates/apiGet.php"));
        Config\Config::writeFile("apiSet.php", file_get_contents("public/maestru/installTemplates/apiSet.php"));
        Config\Config::writeFile("apiView.php", file_get_contents("public/maestru/installTemplates/apiView.php"));
        Config\Config::writeFile("apiApi.php", file_get_contents("public/maestru/installTemplates/apiApi.php"));
        Config\Config::writeFile("apiApiPublic.php", file_get_contents("public/maestru/installTemplates/apiApiPublic.php"));
        Config\Config::writeFile("public/cron/index.php", str_replace('{$path_home}', $dados['path_home'], file_get_contents("public/maestru/installTemplates/cronIndex.txt")));
