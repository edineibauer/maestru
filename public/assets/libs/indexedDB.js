...
async function dbSendData(entity, dados, action) {
    ...
    return new Promise(function (s, f) {
        AJAX.post("entity/up/entity", {entity: entity, dados: convertEmptyArrayToNull(t)}).then(result => {
...
function exeReadOnline(entity, id) {
    ...
    return new Promise(function (resolve) {
        AJAX.post("entity/load/entity", {entity: entity, id: id, historic: null}).then(result => {
            if (!isEmpty(result)) {
                if (id) {
...
const dbRemote = {
    sync(entity, id, feedback) {
        ...
        return dbLocal.exeRead('__historic', 1).then(hist => {
            return new Promise(function (resolve) {
                AJAX.post("entity/load/entity", {entity: entity, historic: (hist[entity] || null)}).then(data => {
                    resolve(data);
                });
            }).then(response => {
                if (response === 0)
